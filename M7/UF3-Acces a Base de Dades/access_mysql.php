...
<body>
	...
	$consulta = "select city.*, country.name as CountryName from city,country where city.CountryCode = country.Code;";
	...
	<table>
		...
		<thead>
			<td colspan="5" align="center" bgcolor="cyan">Llistat de ciutats</td>
		</thead>
		<?php
		# (3.2) Bucle while
